...
navbar.className =
  "flex justify-left items-center w-full bg-gray-100 text-white p-4 shadow-md gap-4";
...
const loginLink: HTMLAnchorElement = document.createElement(
  "a"
...
const registerLink: HTMLAnchorElement = document.createElement(
  "a"
) as HTMLAnchorElement;
...
login.className =
  "flex flex-col justify-center relative left-[500px] mt-10 p-6 bg-white shadow-md rounded w-96";
...
const usernameLabel: HTMLElement = document.createElement(
  "label"
) as HTMLElement;
usernameLabel.className = "block text-gray-700";
usernameLabel.textContent = "Username";

const username: HTMLInputElement = document.createElement(
  "input"
) as HTMLInputElement;
...
const passwordLabel: HTMLElement = document.createElement(
  "label"
) as HTMLElement;
passwordLabel.className = "block text-gray-700";
passwordLabel.textContent = "Password";

const password: HTMLInputElement = document.createElement(
  "input"
) as HTMLInputElement;
...
const loginBtn: HTMLButtonElement = document.createElement(
  "button"
) as HTMLButtonElement;
loginBtn.className =
  "w-full p-2 bg-blue-500 text-white rounded hover:bg-blue-600 active:bg-blue-700";
...
const register: HTMLDivElement = document.createElement(
  "div"
) as HTMLDivElement;
register.className =
  "flex flex-col justify-center relative left-[500px] mt-10 p-6 bg-white shadow-md rounded w-96";
...
const registerUsername: HTMLInputElement = document.createElement(
  "input"
) as HTMLInputElement;
...
const registerPassword: HTMLInputElement = document.createElement(
  "input"
) as HTMLInputElement;
...
const registerBtn: HTMLButtonElement = document.createElement(
  "button"
) as HTMLButtonElement;
